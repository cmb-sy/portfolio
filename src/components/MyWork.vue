<template>
  <div>
    <h1 class="content-title">
      <font-awesome-icon icon="hammer" class="icon" /> Works
    </h1>
    ...
    <ul class="works">
      ...
      <li class="card">
        ...
        <div class="card-content">
          ...
          <br />
          <a href="https://c-2006.firebaseapp.com/" class="card-link"
            >Website</a
          >
          <a
            href="https://github.com/jphacks/C_2006"
            class="card-link github-link"
            >Github</a
          >
        </div>
      ...
      <li class="card">
        ...
        <div class="card-content">
          ...
          <br />
          <a
            href="https://github.com/shoma3571/-portfolio"
            class="card-link github-link"
            >Github</a
          >
        </div>
